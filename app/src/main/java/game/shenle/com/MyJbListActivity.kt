...
/**
 * 我的剧本列表
 * Created by shenle on 2018/3/12.
 */
class MyJbListActivity : BaseActivity<MyJbListModel>() {
    override fun getTNameClass(): Class<MyJbListModel> {
        return MyJbListModel::class.java
    }

    companion object {
        fun goHere() {
            UIUtils.startActivity(MyJbListActivity::class.java)
        }
    }
