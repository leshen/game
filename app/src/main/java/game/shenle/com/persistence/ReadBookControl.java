...
public class ReadBookControl {
    ...
    private ReadBookControl(){
        if(null == textKind){
            ...
            temp1.put("textExtra", UIUtils.INSTANCE.dip2px(6.5f));
            textKind.add(temp1);

            Map<String,Integer> temp2 = new HashMap<>();
            temp2.put("textSize", 16);
            temp2.put("textExtra", UIUtils.INSTANCE.dip2px(8));
            textKind.add(temp2);

            Map<String,Integer> temp3 = new HashMap<>();
            temp3.put("textSize", 17);
            temp3.put("textExtra", UIUtils.INSTANCE.dip2px(9));
            textKind.add(temp3);

            Map<String,Integer> temp4 = new HashMap<>();
            temp4.put("textSize", 20);
            temp4.put("textExtra", UIUtils.INSTANCE.dip2px(11));
            textKind.add(temp4);

            Map<String,Integer> temp5 = new HashMap<>();
            temp5.put("textSize", 22);
            temp5.put("textExtra", UIUtils.INSTANCE.dip2px(13));
            textKind.add(temp5);
        }
        ...
        preference = MyApplication.application.getSharedPreferences("CONFIG", 0);
