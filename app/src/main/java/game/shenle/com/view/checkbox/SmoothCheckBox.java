package game.shenle.com.view.checkbox;
...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, UIUtils.INSTANCE.dip2px(0));
        ta.recycle();
    ...
    private int measureSize(int measureSpec) {
        int defSize = UIUtils.INSTANCE.dip2px(DEF_DRAW_SIZE);
