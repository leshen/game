...
public class BadgeView extends android.support.v7.widget.AppCompatTextView {
	...
	private static final int DEFAULT_BADGE_COLOR = R.color.text_color_2;
	...
	private int badgeMarginTop=-1;
	private int badgeMarginRight=-1;
	private int badgeColor;

	public void setBadgeMarginTopAndRight(int badgeMarginTop,int badgeMarginRight) {
	...
	private ShapeDrawable getDefaultBackground() {
		...
		drawable.getPaint().setColor(getResources().getColor(badgeColor));
